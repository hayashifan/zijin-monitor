...
async def get_commodity_correlation(
    commodity_types: List[str], days: int = 60
) -> Dict:
    """计算股价与各商品的关联性"""
    import asyncio
...
async def get_quant_correlation(days: int = 90) -> Dict:
...
correlation_service = type("CorrelationService", (), {
    "get_commodity_correlation": staticmethod(get_commodity_correlation),
    "get_quant_correlation": staticmethod(get_quant_correlation),
})()
